...
(function() {
    ...
    O = function(b, a) {
        ...
        f = b.toLowerCase();
        f = u(f);
        for (d = j = 0; 0 <= e ? j < e : j > e; d = 0 <= e?++j : --j)
            for (c = k = d; d <= e ? k < e : k > e; c = d <= e?++k : --k)
                if (f.slice(d, + c + 1 || 9E9)in a)
                    i = f.slice(d, + c + 1 || 9E9), g = a[i], h.push({
            pattern: "dictionary",
            i: d,
            j: c,
            ...
            if (a.length) {
                ...
                for (n = r.length; l < n; l++) {
                    ...
                    for (o = j.length; p < o; p++) {
                        ...
                        -1;
                        g = m = 0;
                        for (q = k.length; 0 <= q ? m < q : m > q; g = 0 <= q?++m : --m)
                            if (k[g][0] === a) {
                                f = g;
                                break
                            }
    ...
    q = function(b, a) {
        ...
        for (c = [];;
            ...
            if (!d)break;
            d.i = d.index;
            d.j = d.index + d[0].length-1; c.push(d); b = b.replace(d[0], U(" ", d[0].length)
                )
        }
        return c
    }; P = /\d{3,}/; X = /19\d\d|200\d|201\d/; N = function(b) {
    ...
    M = function(b) {
        ...
        for (j = e.length; i < j; i++)
            c = e[i], a = y(c.day, c.month, c.year), g = a[0], h = a[1], a = h[0], f = h[1], h = h[2], g && k.push({
            pattern: "date",
            i: c.i,
            j: c.j,
    ...
    t = function(b, a) {
        ...
        if (0 === a)
            return 1;
        for (d = e = c = 1; 1 <= a ? e <= a : e >= a; d = 1 <= a?++e : --e)
            c*=b, c/=d, b -= 1;
        return c
    };
    n = function(b) {
    ...
    ka = function(b, a) {
        ...
        for (m = b.length; 0 <= m ? i < m : i > m; f = 0 <= m?++i : --i) {
            ...
            for (l = a.length; j <
            l; j++)
                h = a[j], h.j === f && (g = [h.i, h.j], e = g[0], g = g[1], e = (k[e-1] || 0) + ba(h), e < k[g] && (k[g] = e, d[g] = h))
        }
        i = [];
        for (f = b.length-1; 0 <= f;)(h = d[f]) 
            ? (i.push(h), f = h.i-1) : f -= 1;
        i.reverse();
        d = function(a, d) {
            return {
                pattern: "bruteforce",
        ...
        for (m = i.length; l < m; l++)
            h = i[l], g = [h.i, h.j], e = g[0], g = g[1], 0 < e - f && j.push(d(f, e-1)), f = g + 1, j.push(h);
    ...
    na = function(b) {
        ...
        for (c = j = 2; 2 <= a ? j <= a : j >= a; c = 2 <= a?++j : --j) {
            g = Math.min(i, c-1);
            for (e = k = 1; 1 <= g ? k <= g : k >= g; e = 1 <= g?++k : --k)
        ...
        if (b.shifted_count) {
            ...
            c = e = f = 0;
            for (g = Math.min(a, b); 0 <= g ? e <= g : e >= g; c = 0 <= g?++e : --e)
                f += t(a + b, c);
            d += n(f)
        }
        return d
    ...
    ia = function(b) {
        ...
        for (g in j) {
            ...
            e = i = 0;
            for (k = Math.min(d, a); 0 <= k ? i <= k : i >= k; e = 0 <= k?++i : --i)
                f += t(d + a, e)
        }
        return n(f) || 1
    };
    D = function(b) {
        ...
        i = b.split("");
        b = 0;
        for (h = i.length; b < h; b++)
            a = i[b], a = a.charCodeAt(0), 48 <= a && 57 >= a ? d=!0 : 65 <= a && 90 >= a ? g=!0 : 97 <= a && 122 >= a ? c=!0 : 127 >= a ? e=!0 : f=!0;
        b = 0;
        d && (b += 10);
        g && (b += 26);
        c && (b += 26);
    ...
    B = v.concat([function(b) {
        ...
        for (m = o.length; j < m; j++) {
            ...
            for (p = v.length; k < p; k++) {
                ...
                q = c(e);
                l = 0;
                for (n = q.length; l < n; l++)
                    if (c = q[l], i = b.slice(c.i, + c.j + 1 || 9E9)
                        , i.toLowerCase() !== c.matched_word) {
                    e = {};
                    for (h in g)
                        a = g[h], -1 !== i.indexOf(h) && (e[h] = a);
                    c.l33t=!0;
                    c.token = i;
                    c.sub = e;
                    i = c;
        ...
        c = 0;
        for (e = f.length; c < e; c++)
            a = f[c], d = [a.i, a.j], a = d[0], d = d[1], g.push({
            pattern: "digits",
            i: a,
            j: d,
            token: b.slice(a, + d + 1 || 9E9)
        ...
        for (f = 0; f < b.length;) {
            ...
            if (j)
                for (; ;)
                    if (e = b.slice(g-1, + g + 1 || 9E9), h = e[0], d = e[1], c = function() {
                        var b, c, e, f;
                        e = [h, d];
                        f = [];
                        b = 0;
    ...
    o = function(b, a) {
        ...
        if (null != a) {
            d = e = 0;
            for (f = a.length; 0 <= f ? e < f : e > f; d = 0 <= f?++e : --e)
                I[u(a[d].toLowerCase())] = d + 1
        }
        d = S(b);
        d = ka(b, d);
        d.calc_time = J() - c;
